...
const PRESET_LIBRARY = [
  ...
  // ============================================================
  {
    ...
    data: {
      mod1Gain: 0, mod1Ratio: 1, mod1Wave: "sine",
      mod2Gain: 0, mod2Ratio: 2, mod2Wave: "sine",
      fmDepthPreset: 0,
      harmonic1Gain: 0, harmonic1Offset: 0,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "piano",
      personality: 0, // Clean
      stereoWidth: 0, detune: 0, chorus: 0, delay: 0, reverb: 0,
      wetDryMix: 80, compressor: true,
    }
  },
  {
    name: "Pure Sine",
    ...
    data: {
      ...
      envelope: "pluck",
      personality: 0, // Clean
      stereoWidth: 0, detune: 0, chorus: 0, delay: 0, reverb: 2,
      wetDryMix: 50, compressor: true,
    }
  },
  {
    name: "Soft Touch",
    ...
    data: {
      mod1Gain: 25, mod1Ratio: 1, mod1Wave: "sine",
      mod2Gain: 10, mod2Ratio: 2, mod2Wave: "sine",
      fmDepthPreset: 2,
      harmonic1Gain: 0, harmonic1Offset: 0,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "piano",
      personality: 1, // Analog Drift
      stereoWidth: 2, detune: 1, chorus: 1, delay: 0, reverb: 3,
      wetDryMix: 65, compressor: true,
    }
  },
  {
    name: "Bright Start",
    ...
    data: {
      mod1Gain: 40, mod1Ratio: 2, mod1Wave: "sine",
      mod2Gain: 15, mod2Ratio: 3, mod2Wave: "sine",
      fmDepthPreset: 3,
      harmonic1Gain: 0, harmonic1Offset: 0,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "pluck",
      personality: 0, // Clean
      stereoWidth: 3, detune: 2, chorus: 2, delay: 1, reverb: 4,
      wetDryMix: 70, compressor: true,
    }
  },
  {
    name: "Sub Foundation",
    ...
    data: {
      mod1Gain: 20, mod1Ratio: 1, mod1Wave: "sine",
      mod2Gain: 0, mod2Ratio: 2, mod2Wave: "sine",
      fmDepthPreset: 1,
      harmonic1Gain: 60, harmonic1Offset: -12,
      harmonic2Gain: 35, harmonic2Offset: -24,
      envelope: "piano",
      personality: 0, // Clean
      stereoWidth: 1, detune: 0, chorus: 0, delay: 0, reverb: 2,
      wetDryMix: 55, compressor: true,
    }
  },
  ...
  // ============================================================
  {
    ...
    data: {
      mod1Gain: 65, mod1Ratio: 1.414, mod1Wave: "sine",
      mod2Gain: 0, mod2Ratio: 2, mod2Wave: "sine",
      fmDepthPreset: 8,
      harmonic1Gain: 0, harmonic1Offset: 0,
      harmonic2Gain: 0, harmonic2Offset: 0,
      ...
      stereoWidth: 3, detune: 2, chorus: 0, delay: 0, reverb: 6,
      wetDryMix: 75, compressor: true,
    }
  },
  {
    name: "Glass Chime",
    ...
    data: {
      mod1Gain: 70, mod1Ratio: 1.414, mod1Wave: "sine",
      mod2Gain: 30, mod2Ratio: 3.5, mod2Wave: "sine",
      fmDepthPreset: 9,
      harmonic1Gain: 25, harmonic1Offset: 12,
      harmonic2Gain: 15, harmonic2Offset: 24,
      envelope: "bell",
      personality: 6, // Bell Shimmer
      stereoWidth: 5, detune: 3, chorus: 3, delay: 0, reverb: 8,
      wetDryMix: 80, compressor: true,
    }
  },
  {
    ...
    data: {
      mod1Gain: 60, mod1Ratio: 0.75, mod1Wave: "sine",
      mod2Gain: 25, mod2Ratio: 1.5, mod2Wave: "sine",
      fmDepthPreset: 10,
      harmonic1Gain: 0, harmonic1Offset: 0,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "bell",
      personality: 8, // Warble
      stereoWidth: 4, detune: 1, chorus: 0, delay: 0, reverb: 9,
      wetDryMix: 70, compressor: true,
    }
  },
  {
    ...
    data: {
      mod1Gain: 55, mod1Ratio: 4, mod1Wave: "sine",
      mod2Gain: 20, mod2Ratio: 7, mod2Wave: "sine",
      fmDepthPreset: 6,
      harmonic1Gain: 0, harmonic1Offset: 0,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "tick",
      personality: 0, // Clean
      stereoWidth: 6, detune: 2, chorus: 2, delay: 2, reverb: 5,
      wetDryMix: 75, compressor: true,
    }
  },
  {
    ...
    data: {
      mod1Gain: 75, mod1Ratio: 3, mod1Wave: "sine",
      mod2Gain: 35, mod2Ratio: 5, mod2Wave: "sine",
      fmDepthPreset: 7,
      harmonic1Gain: 20, harmonic1Offset: 12,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "pluck",
      personality: 6, // Bell Shimmer
      stereoWidth: 4, detune: 2, chorus: 0, delay: 1, reverb: 6,
      wetDryMix: 65, compressor: true,
    }
  },
  ...
  // ============================================================
  {
    ...
    data: {
      mod1Gain: 35, mod1Ratio: 1, mod1Wave: "sine",
      mod2Gain: 15, mod2Ratio: 2, mod2Wave: "sine",
      fmDepthPreset: 3,
      harmonic1Gain: 40, harmonic1Offset: -12,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "piano",
      personality: 1, // Analog Drift
      stereoWidth: 2, detune: 3, chorus: 2, delay: 1, reverb: 3,
      wetDryMix: 70, compressor: true,
    }
  },
  {
    ...
    data: {
      mod1Gain: 55, mod1Ratio: 1, mod1Wave: "sine",
      mod2Gain: 20, mod2Ratio: 2, mod2Wave: "sine",
      fmDepthPreset: 4,
      harmonic1Gain: 0, harmonic1Offset: 0,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "epiano",
      personality: 3, // Tremolo
      stereoWidth: 4, detune: 3, chorus: 4, delay: 2, reverb: 4,
      wetDryMix: 65, compressor: true,
    }
  },
  {
    ...
    data: {
      mod1Gain: 65, mod1Ratio: 1, mod1Wave: "sine",
      mod2Gain: 30, mod2Ratio: 2, mod2Wave: "sine",
      fmDepthPreset: 5,
      harmonic1Gain: 15, harmonic1Offset: 12,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "epiano",
      personality: 4, // Vibrato
      stereoWidth: 5, detune: 4, chorus: 5, delay: 1, reverb: 3,
      wetDryMix: 60, compressor: true,
    }
  },
  {
    name: "Honky Tonk",
    ...
    data: {
      mod1Gain: 40, mod1Ratio: 1, mod1Wave: "sine",
      mod2Gain: 20, mod2Ratio: 2, mod2Wave: "sine",
      fmDepthPreset: 3,
      harmonic1Gain: 35, harmonic1Offset: 0,
      harmonic2Gain: 30, harmonic2Offset: 0,
      envelope: "piano",
      personality: 2, // Tape Wow
      stereoWidth: 3, detune: 8, chorus: 0, delay: 0, reverb: 2,
      wetDryMix: 50, compressor: true,
    }
  },
  {
    ...
    data: {
      mod1Gain: 50, mod1Ratio: 1, mod1Wave: "sine",
      mod2Gain: 25, mod2Ratio: 3, mod2Wave: "sine",
      fmDepthPreset: 4,
      harmonic1Gain: 20, harmonic1Offset: -12,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "epiano",
      personality: 1, // Analog Drift
      stereoWidth: 6, detune: 5, chorus: 7, delay: 3, reverb: 5,
      wetDryMix: 75, compressor: true,
    }
  },
  ...
  // ============================================================
  {
    ...
    data: {
      mod1Gain: 45, mod1Ratio: 1, mod1Wave: "sine",
      mod2Gain: 20, mod2Ratio: 2, mod2Wave: "sine",
      fmDepthPreset: 2,
      harmonic1Gain: 50, harmonic1Offset: -12,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "pluck",
      personality: 0, // Clean
      stereoWidth: 1, detune: 1, chorus: 0, delay: 0, reverb: 1,
      wetDryMix: 50, compressor: true,
    }
  },
  {
    ...
    data: {
      mod1Gain: 35, mod1Ratio: 2, mod1Wave: "sine",
      mod2Gain: 15, mod2Ratio: 3, mod2Wave: "sine",
      fmDepthPreset: 3,
      harmonic1Gain: 25, harmonic1Offset: 12,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "pluck",
      personality: 1, // Analog Drift
      stereoWidth: 4, detune: 2, chorus: 3, delay: 1, reverb: 6,
      wetDryMix: 70, compressor: true,
    }
  },
  {
    ...
    data: {
      mod1Gain: 50, mod1Ratio: 1.5, mod1Wave: "sine",
      mod2Gain: 25, mod2Ratio: 3, mod2Wave: "sine",
      fmDepthPreset: 5,
      harmonic1Gain: 20, harmonic1Offset: 0,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "pluck",
      personality: 2, // Tape Wow
      stereoWidth: 5, detune: 3, chorus: 2, delay: 2, reverb: 7,
      wetDryMix: 75, compressor: true,
    }
  },
  {
    ...
    data: {
      mod1Gain: 40, mod1Ratio: 2, mod1Wave: "square",
      mod2Gain: 0, mod2Ratio: 2, mod2Wave: "sine",
      fmDepthPreset: 5,
      harmonic1Gain: 70, harmonic1Offset: 7,
      harmonic2Gain: 50, harmonic2Offset: 12,
      envelope: "pluck",
      personality: 5, // Growl
      stereoWidth: 6, detune: 4, chorus: 0, delay: 3, reverb: 5,
      wetDryMix: 60, compressor: true,
    }
  },
  {
    ...
    data: {
      mod1Gain: 30, mod1Ratio: 1, mod1Wave: "sine",
      mod2Gain: 15, mod2Ratio: 2, mod2Wave: "sine",
      fmDepthPreset: 1,
      harmonic1Gain: 0, harmonic1Offset: 0,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "tick",
      personality: 0, // Clean
      stereoWidth: 3, detune: 1, chorus: 0, delay: 0, reverb: 4,
      wetDryMix: 60, compressor: true,
    }
  },
  ...
  // ============================================================
  {
    ...
    data: {
      mod1Gain: 45, mod1Ratio: 1.5, mod1Wave: "sine",
      mod2Gain: 25, mod2Ratio: 2.5, mod2Wave: "sine",
      fmDepthPreset: 16,
      harmonic1Gain: 30, harmonic1Offset: 12,
      harmonic2Gain: 20, harmonic2Offset: 24,
      envelope: "pad",
      personality: 7, // Choir Breathe
      stereoWidth: 8, detune: 5, chorus: 8, delay: 6, reverb: 11,
      wetDryMix: 85, compressor: true,
    }
  },
  {
    name: "Dream Pad",
    ...
    data: {
      mod1Gain: 50, mod1Ratio: 1, mod1Wave: "sine",
      mod2Gain: 30, mod2Ratio: 3, mod2Wave: "sine",
      fmDepthPreset: 18,
      harmonic1Gain: 25, harmonic1Offset: 7,
      harmonic2Gain: 20, harmonic2Offset: 19,
      envelope: "pad",
      personality: 8, // Warble
      stereoWidth: 10, detune: 7, chorus: 10, delay: 8, reverb: 13,
      wetDryMix: 90, compressor: true,
    }
  },
  {
    name: "Warm Strings",
    ...
    data: {
      ...
      envelope: "string",
      personality: 4, // Vibrato
      stereoWidth: 6, detune: 4, chorus: 6, delay: 0, reverb: 7,
      wetDryMix: 75, compressor: true,
    }
  },
  {
    ...
    data: {
      ...
      mod2Gain: 25, mod2Ratio: 1.5, mod2Wave: "sine",
      fmDepthPreset: 17,
      harmonic1Gain: 20, harmonic1Offset: 4,
      harmonic2Gain: 15, harmonic2Offset: 7,
      envelope: "choir",
      personality: 7, // Choir Breathe
      stereoWidth: 7, detune: 6, chorus: 9, delay: 4, reverb: 10,
      wetDryMix: 80, compressor: true,
    }
  },
  {
    ...
    data: {
      mod1Gain: 55, mod1Ratio: 1.414, mod1Wave: "sine",
      mod2Gain: 30, mod2Ratio: 3.5, mod2Wave: "sine",
      fmDepthPreset: 19,
      harmonic1Gain: 35, harmonic1Offset: 12,
      harmonic2Gain: 25, harmonic2Offset: 24,
      envelope: "pad",
      personality: 6, // Bell Shimmer
      stereoWidth: 9, detune: 8, chorus: 11, delay: 9, reverb: 12,
      wetDryMix: 88, compressor: true,
    }
  },
  ...
  // ============================================================
  {
    ...
    data: {
      mod1Gain: 60, mod1Ratio: 1, mod1Wave: "square",
      mod2Gain: 30, mod2Ratio: 2, mod2Wave: "sine",
      fmDepthPreset: 10,
      harmonic1Gain: 0, harmonic1Offset: 0,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "brass",
      personality: 4, // Vibrato
      stereoWidth: 5, detune: 3, chorus: 4, delay: 0, reverb: 5,
      wetDryMix: 65, compressor: true,
    }
  },
  {
    ...
    data: {
      mod1Gain: 70, mod1Ratio: 2, mod1Wave: "square",
      mod2Gain: 35, mod2Ratio: 3, mod2Wave: "sine",
      fmDepthPreset: 8,
      harmonic1Gain: 0, harmonic1Offset: 0,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "pluck",
      personality: 4, // Vibrato
      stereoWidth: 4, detune: 3, chorus: 3, delay: 2, reverb: 4,
      wetDryMix: 70, compressor: true,
    }
  },
  {
    ...
    data: {
      mod1Gain: 25, mod1Ratio: 1, mod1Wave: "sine",
      mod2Gain: 10, mod2Ratio: 3, mod2Wave: "sine",
      fmDepthPreset: 11,
      harmonic1Gain: 0, harmonic1Offset: 0,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "brass",
      personality: 1, // Analog Drift
      stereoWidth: 3, detune: 2, chorus: 2, delay: 0, reverb: 6,
      wetDryMix: 70, compressor: true,
    }
  },
  {
    ...
    data: {
      mod1Gain: 65, mod1Ratio: 1.5, mod1Wave: "sine",
      mod2Gain: 35, mod2Ratio: 2.5, mod2Wave: "sine",
      fmDepthPreset: 12,
      harmonic1Gain: 20, harmonic1Offset: 7,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "brass",
      personality: 4, // Vibrato
      stereoWidth: 2, detune: 1, chorus: 1, delay: 0, reverb: 4,
      wetDryMix: 60, compressor: true,
    }
  },
  {
    ...
    data: {
      mod1Gain: 55, mod1Ratio: 1, mod1Wave: "saw",
      mod2Gain: 25, mod2Ratio: 2, mod2Wave: "square",
      fmDepthPreset: 6,
      harmonic1Gain: 40, harmonic1Offset: 0,
      harmonic2Gain: 35, harmonic2Offset: 12,
      envelope: "pluck",
      personality: 8, // Warble
      stereoWidth: 8, detune: 9, chorus: 0, delay: 2, reverb: 5,
      wetDryMix: 65, compressor: true,
    }
  },
  ...
  // ============================================================
  {
    ...
    data: {
      mod1Gain: 30, mod1Ratio: 0.5, mod1Wave: "sine",
      mod2Gain: 0, mod2Ratio: 1, mod2Wave: "sine",
      fmDepthPreset: 1,
      harmonic1Gain: 70, harmonic1Offset: -12,
      harmonic2Gain: 50, harmonic2Offset: -24,
      envelope: "drone",
      personality: 0, // Clean
      stereoWidth: 0, detune: 0, chorus: 0, delay: 0, reverb: 1,
      wetDryMix: 40, compressor: true,
    }
  },
  {
    name: "Reese Bass",
    ...
    data: {
      mod1Gain: 60, mod1Ratio: 1, mod1Wave: "saw",
      mod2Gain: 30, mod2Ratio: 1, mod2Wave: "saw",
      fmDepthPreset: 4,
      harmonic1Gain: 45, harmonic1Offset: -12,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "drone",
      personality: 8, // Warble
      stereoWidth: 5, detune: 10, chorus: 0, delay: 0, reverb: 2,
      wetDryMix: 50, compressor: true,
    }
  },
  {
    ...
    data: {
      mod1Gain: 70, mod1Ratio: 1, mod1Wave: "sine",
      mod2Gain: 40, mod2Ratio: 2, mod2Wave: "square",
      fmDepthPreset: 6,
      harmonic1Gain: 35, harmonic1Offset: -12,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "pluck",
      personality: 5, // Growl
      stereoWidth: 2, detune: 2, chorus: 0, delay: 0, reverb: 1,
      wetDryMix: 45, compressor: true,
    }
  },
  {
    name: "Wobble Bass",
    ...
    data: {
      mod1Gain: 75, mod1Ratio: 1, mod1Wave: "square",
      mod2Gain: 45, mod2Ratio: 0.5, mod2Wave: "sine",
      fmDepthPreset: 7,
      harmonic1Gain: 50, harmonic1Offset: -12,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "brass",
      personality: 3, // Tremolo
      stereoWidth: 4, detune: 6, chorus: 0, delay: 0, reverb: 2,
      wetDryMix: 55, compressor: true,
    }
  },
  {
    ...
    data: {
      mod1Gain: 80, mod1Ratio: 0.5, mod1Wave: "sine",
      mod2Gain: 40, mod2Ratio: 1, mod2Wave: "sine",
      fmDepthPreset: 2,
      harmonic1Gain: 0, harmonic1Offset: 0,
      harmonic2Gain: 0, harmonic2Offset: 0,
      envelope: "blip",
  ...
  // ============================================================
  {
    ...
    data: {
      mod1Gain: 85, mod1Ratio: 7, mod1Wave: "square",
      mod2Gain: 50, mod2Ratio: 5, mod2Wave: "square",
      fmDepthPreset: 14,
      harmonic1Gain: 30, harmonic1Offset: 7,
      harmonic2Gain: 25, harmonic2Offset: -5,
      envelope: "drone",
      personality: 8, // Warble
      stereoWidth: 10, detune: 8, chorus: 0, delay: 7, reverb: 11,
      wetDryMix: 80, compressor: true,
    }
  },
  {
    ...
    data: {
      mod1Gain: 70, mod1Ratio: 3.5, mod1Wave: "sine",
      mod2Gain: 45, mod2Ratio: 7, mod2Wave: "sine",
      fmDepthPreset: 13,
      harmonic1Gain: 40, harmonic1Offset: 19,
      harmonic2Gain: 30, harmonic2Offset: 31,
      envelope: "tick",
      personality: 9, // Unstable
      stereoWidth: 12, detune: 11, chorus: 7, delay: 10, reverb: 14,
      wetDryMix: 92, compressor: true,
    }
  },
  {
    ...
    data: {
      mod1Gain: 65, mod1Ratio: 2.5, mod1Wave: "square",
      mod2Gain: 40, mod2Ratio: 3.5, mod2Wave: "saw",
      fmDepthPreset: 15,
      harmonic1Gain: 35, harmonic1Offset: -17,
      harmonic2Gain: 30, harmonic2Offset: 23,
      envelope: "wash",
      personality: 9, // Unstable
      stereoWidth: 13, detune: 12, chorus: 12, delay: 11, reverb: 15,
      wetDryMix: 95, compressor: true,
    }
  },
  {
    name: "Glitch Stutter",
    ...
    data: {
      mod1Gain: 80, mod1Ratio: 4, mod1Wave: "square",
      mod2Gain: 60, mod2Ratio: 7, mod2Wave: "square",
      fmDepthPreset: 19,
      harmonic1Gain: 50, harmonic1Offset: 5,
      harmonic2Gain: 45, harmonic2Offset: -7,
      envelope: "blip",
      personality: 9, // Unstable
      stereoWidth: 11, detune: 13, chorus: 0, delay: 12, reverb: 8,
      wetDryMix: 75, compressor: true,
    }
  },
  {
    ...
    data: {
      ...
      envelope: "wash",
      personality: 7, // Choir Breathe
      stereoWidth: 15, detune: 10, chorus: 14, delay: 15, reverb: 15,
      wetDryMix: 98, compressor: true,
    }
  },
];
...
window.initEnvelopeUI = function () {
  ...
  if (personalitySlider && personalityValue) {
    personalitySlider.addEventListener("input", () => {
      ...
      const names = [
        "Clean", "Analog Drift", "Tape Wow", "Tremolo", "Vibrato",
        "Growl", "Bell Shimmer", "Choir Breathe", "Warble", "Unstable"
      ];
...
function loadSession() {
  try {
    ...
    console.log("📂 Loading saved session from", new Date(session.timestamp).toLocaleString());
...
function setRatioButton(modIndex, ratio) {
  ...
  const btn = Array.from(row.querySelectorAll('.ratio-btn'))
    .find(b => Number(b.dataset.ratio) === ratio);
  if (btn) btn.click();
}
...
function setupAutoSave() {
  ...
  document.addEventListener('click', (e) => {
    if (e.target.closest('.ratio-btn, .preset-btn, .engine-btn, .eq-band-btn')) {
